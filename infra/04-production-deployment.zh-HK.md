...
- [简体中文](04-production-deployment.zh-CN.md) - 簡體中文
- **繁體中文** (當前) - 本文檔

## 目錄

1. [環境層級](#1-環境層級)
2. [映像檔建構與標籤](#2-映像檔建構與標籤)
3. [密鑰管理](#3-密鑰管理)
4. [資料庫遷移](#4-資料庫遷移)
5. [資料庫備份與還原](#5-資料庫備份與還原)
6. [預備環境部署](#6-預備環境部署)
7. [生產環境部署](#7-生產環境部署)
...
*上一篇：[第三部分：開發環境](03-development-environment.zh-HK.md)*
*下一篇：[第五部分：營運與疑難排解](05-operations-troubleshooting.zh-HK.md) — 監控、回滾與常見問題。*
