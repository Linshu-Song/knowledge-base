...
- [English](./infrastructure-setup) - 英文
- [简体中文](./infrastructure-setup) - 簡體中文
- **繁體中文** (當前) - 本文檔
...
*上一篇：[第一部分：架構概述](./architecture-overview)*
*下一篇：[第三部分：開發環境](./development-environment) — Dev Containers、Git/SSH 設定及日常工作流程。*
