...
:::caution Monorepo Context
In a monorepo, set `build.context` to the repository root (`..`) to enable copying shared libraries, while pointing `dockerfile` to the specific service directory.
:::
...
*Next: [Development Environment](./development-environment)*
