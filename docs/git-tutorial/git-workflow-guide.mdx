...
1. **Never force push to shared branches** (`main`, `develop`) - use `--force-with-lease` instead
2. **Never rewrite published history** - treat pushed commits as immutable
...
*   [📄 Submodules Guide](./git-composition-strategy/submodule.mdx) — Manage external dependencies.
