...
|------|---------|------------|
| **pyproject.toml** | 🎯 **Central configuration file** | [Complete Guide →](pyproject-guide.mdx) |
...
> **📖 Deep Dive**: For comprehensive pyproject.toml configuration, see our [Complete Guide to pyproject.toml](pyproject-guide.mdx)
...
> **📖 Deep Dive**: For comprehensive uv usage and management, see our [Complete Guide to uv](uv-guide.mdx)
...
> **📖 Deep Dive**: For detailed comparison of code quality tools, see our [Introduction to Python Code Quality Tools](python-tools-introduction.mdx)
...
| Guide | Focus | Link |
|-------|-------|-----|
| **[pyproject.toml Guide](pyproject-guide.mdx)** | Complete project configuration | 🔗 Local |
| **[uv Guide](uv-guide.mdx)** | Modern package management | 🔗 Local |
| **[Code Quality Tools](python-tools-introduction.mdx)** | Linting, formatting, type checking | 🔗 Local |
