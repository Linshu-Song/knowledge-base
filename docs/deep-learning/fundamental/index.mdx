...
| :--- | :--- | :--- |
| **[.pt / .pth](./pytorch-pt-guide)** | Training | Native PyTorch storage for weights and architectures. |
| **[.onnx](./onnx-overview)** | Conversion | Universal bridge between frameworks (Open Neural Network Exchange). |
| **[.engine / .plan](./tensorrt-engine)** | Deployment | High-performance optimized inference on NVIDIA GPUs. |
| **[.wts](./wts-bridge)** | Bridge | Plain text weight storage for custom TensorRT builders. |
