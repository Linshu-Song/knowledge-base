...
The Task Aim determines how TrackNet and TSM work and process input differently:
...
![alt TrackNetV1](figures/TrackNetV1.png)

Input: $W \times H \times (\text{3 Frames}(t, t-1, t-2) \times \text{RGB})$

Output: $W \times H \times 1$

![alt TrackNetV1Output](figures/TrackNetV1Output.png)
...
$$P(i, j, k)=\frac{e^{L(i, j, k)}}{\sum_{t=0}^{255}e^{L(i, j, k)}}$$
...
![alt TracknetV2](figures/TrackNetV2.png)

![alt TrackNetV2Detail](figures/TrackNetV2Detail.png)
...
![alt TrackNetV3](figures/TrackNetV3.png)
